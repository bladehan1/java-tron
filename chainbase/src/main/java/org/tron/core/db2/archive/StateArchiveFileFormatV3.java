...
public final class StateArchiveFileFormatV3 {
  ...
  // Frozen at 2_000_000_000: the value is bound into the v3 composite format identity and
  // into persisted CURRENT records, so it must not track the v4/v5 target of 2 GiB.
